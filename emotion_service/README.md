...
> Note: filenames above match the scripts present in the repository. If your copy uses nested folders (e.g. a `preprocessing/` subfolder), adapt the paths accordingly.
